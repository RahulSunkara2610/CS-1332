...
public class MaxHeap<T extends Comparable<? super T>> {
    ...
    /**
     * Helper method for switching two values
     *
     * @param one the first data that will be swapped
     * @param two the second data that will be swapped
     */
    private void move(int one, int two) {
        T temp = backingArray[one];
        backingArray[one] = backingArray[two];
        backingArray[two] = temp;
    }
